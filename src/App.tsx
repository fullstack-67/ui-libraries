...
// Dark mode available via switcher
// import "@picocss/pico";

// No dark mode
// import "skeleton-css/css/skeleton.css";

// Dark mode available via Rendering in Dev Tool
// import "beercss";
  ...
  return (
    <main style={{ position: "relative" }}>
      ...
      <section>
        ...
        <article>
          <p>
            ...
            acronym tag like this: <i title="For The Win">ftw</i>. You can
          ...
          <p>
            ...
            <samp>samp</samp> tags. Even more specifically, there is a tag just
            for <var>variables</var>. Not to be mistaken with blockquotes below,
            the quote tag lets you denote something as <q>quoted text</q>.
            Lastly don't forget the sub (H<sub>2</sub>O) and sup (E = MC
            <sup>2</sup>) tags.
          </p>
        </article>
      ...
      <figure>
        ...
        <figcaption>
          Fig1. Random Images from{" "}
          <a href="https://picsum.photos/200">picsum.photos</a>
        </figcaption>
      </figure>
      <hr />
      <section>
